...
phina.namespace(function () {
    ...
    phina.define('phina.geom.Vector2', {
        ...
        _static: {
             ...
             */
            min: function (a, b) {
                return phina.geom.Vector2((a.x < b.x) ? a.x : b.x, (a.y < b.y) ? a.y : b.y);
            },
            /**
             * @method max
             * @static
             ...
             */
            lerp: function (a, b, t) {
                return phina.geom.Vector2(a.x + (b.x - a.x) * t, a.y + (b.y - a.y) * t);
            },
            /**
             * @method slerp
             * @static
...
phina.namespace(function () {
    ...
    phina.define('phina.geom.Matrix33', {
         ...
         */
        clone: function () {
            return phina.geom.Matrix33(this.m00, this.m01, this.m02, this.m10, this.m11, this.m12, this.m20, this.m21, this.m22);
        },
        /**
         * @method determinant
         * 行列式を返します
    ...
    phina.define('phina.geom.Collision', {
        _static: {
            ...
            testCircleLine: function (circle, p1, p2) {
                // 先に線分端との判定
                if (circle.contains(p1.x, p1.y) || circle.contains(p2.x, p2.y))
                    return true;
                // 半径の2乗
            ...
            testLineLine: function (p1, p2, p3, p4) {
                ...
                if (p1.x == p2.x && p1.x == p3.x && p1.x == p4.x) {
                    ...
                    if (min <= p3.y && p3.y <= max || min <= p4.y && p4.y <= max)
                        return true;
                    return false;
                }
                if (p1.y == p2.y && p1.y == p3.y && p1.y == p4.y) {
                    ...
                    if (min <= p3.x && p3.x <= max || min <= p4.x && p4.x <= max)
                        return true;
                    return false;
                }
                //通常判定
            ...
            testRectLine: function (rect, p1, p2) {
                ...
                if (rect.left <= p1.x && p1.x <= rect.right && rect.top <= p1.y && p1.y <= rect.bottom)
                    return true;
                //矩形の４点
                ...
                //矩形の４辺をなす線分との接触判定
                if (phina.geom.Collision.testLineLine(p1, p2, r1, r2))
                    return true;
                if (phina.geom.Collision.testLineLine(p1, p2, r2, r3))
                    return true;
                if (phina.geom.Collision.testLineLine(p1, p2, r3, r4))
                    return true;
                if (phina.geom.Collision.testLineLine(p1, p2, r1, r4))
                    return true;
                return false;
            },
        }
        ...
        _static: {
            ...
            EASING: {
                ...
                easeOutInCubic: function (t, b, c, d) {
                    if (t < d / 2)
                        return phina.util.Tween.EASING.easeOutCubic(t * 2, b, c / 2, d);
                ...
                easeOutInQuart: function (t, b, c, d) {
                    if (t < d / 2)
                        return phina.util.Tween.EASING.easeOutQuart(t * 2, b, c / 2, d);
                ...
                easeOutInQuint: function (t, b, c, d) {
                    if (t < d / 2)
                        return phina.util.Tween.EASING.easeOutQuint(t * 2, b, c / 2, d);
                ...
                easeOutInSine: function (t, b, c, d) {
                    if (t < d / 2)
                        return phina.util.Tween.EASING.easeOutSine(t * 2, b, c / 2, d);
                ...
                easeOutInExpo: function (t, b, c, d) {
                    if (t < d / 2)
                        return phina.util.Tween.EASING.easeOutExpo(t * 2, b, c / 2, d);
                ...
                easeOutInCirc: function (t, b, c, d) {
                    if (t < d / 2)
                        return phina.util.Tween.EASING.easeOutCirc(t * 2, b, c / 2, d);
                ...
                easeOutInElastic: function (t, b, c, d, a, p) {
                    if (t < d / 2)
                        return phina.util.Tween.EASING.easeOutElastic(t * 2, b, c / 2, d, a, p);
                ...
                easeOutInBack: function (t, b, c, d, s) {
                    if (t < d / 2)
                        return phina.util.Tween.EASING.easeOutBack(t * 2, b, c / 2, d, s);
                ...
                easeInOutBounce: function (t, b, c, d) {
                    if (t < d / 2)
                        return phina.util.Tween.EASING.easeInBounce(t * 2, 0, c, d) * .5 + b;
                    else
                        return phina.util.Tween.EASING.easeOutBounce(t * 2 - d, 0, c, d) * .5 + c * .5 + b;
                },
                /** easeOutInBounce */
                easeOutInBounce: function (t, b, c, d) {
                    if (t < d / 2)
                        return phina.util.Tween.EASING.easeOutBounce(t * 2, b, c / 2, d);
...
phina.namespace(function () {
    ...
    phina.define('phina.input.Keyboard', {
        ...
        getKeyAngle: function () {
            var angle = null;
            var arrowBit = (this.getKey("left") << 3) | // 1000
...
phina.namespace(function () {
    ...
    phina.define('phina.app.Interactive', {
        ...
        check: function (root) {
            ...
            if (!this._enable || !this.app.pointers)
                return;
        ...
        init: function (target) {
            ...
            this.on('attached', function () {
                ...
                this.target.on('pointstart', function (e) {
                    if (phina.accessory.Draggable._lock)
                        return;
                    this._dragging = true;
        ...
        init: function (target) {
            ...
            this.on('attached', function () {
                ...
                this.target.on('pointstay', function (e) {
                    ...
                    if (self.cacheList.length > 3)
                        self.cacheList.shift();
    ...
    phina.define('phina.graphics.Canvas', {
        ...
        polygon: function (x, y, size, sides, offsetAngle) {
            ...
            for (var i = 1; i < sides; ++i) {
                ...
                this.lineTo(x + Math.cos(rad) * size, y + Math.sin(rad) * size);
            }
            this.closePath();
            return this;
        },
        ...
        star: function (x, y, radius, sides, sideIndent, offsetAngle) {
            ...
            this.moveTo(x + Math.cos(radOffset) * radius, y + Math.sin(radOffset) * radius);
            for (var i = 1; i < sides * 2; ++i) {
                var rad = radDiv * i + radOffset;
                var len = (i % 2) ? sideIndentRadius : radius;
                this.lineTo(x + Math.cos(rad) * len, y + Math.sin(rad) * len);
            }
            this.closePath();
            return this;
        },
...
phina.namespace(function () {
    ...
    phina.define('phina.display.PlainElement', {
        ...
        draw: function (canvas) {
            ...
            canvas.context.drawImage(image, 0, 0, w, h, x, y, w, h);
        },
    });
});
phina.namespace(function () {
...
phina.namespace(function () {
    ...
    phina.define('phina.display.Sprite', {
        ...
        draw: function (canvas) {
            ...
            canvas.context.drawImage(image, srcRect.x, srcRect.y, srcRect.width, srcRect.height, -this._width * this.originX, -this._height * this.originY, this._width, this._height);
        },
...
phina.namespace(function () {
    ...
    phina.define('phina.display.CanvasRenderer', {
        ...
        renderObject: function (obj) {
            if (obj.visible === false && !obj.interactive)
                return;
